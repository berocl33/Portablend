...
const char * libloaded = "/data/data/org.blender.play/lib";
const char * libstatic = "/data/data/org.blender.play/lib";
const char * libloadernew= "/data/data/org.blender.play/lib";
const char * libloadeddir = "/data/data/org.blender.play/";
...
int pushlibrary(const char * libname) {
    ...
    if(!(srclib = getpathlib(libloadernew, libname, 0, 1)))
    {
       //printd("failed");
        return 0;
    }
...
//Maybe if not a release aswell continue	  
	}
